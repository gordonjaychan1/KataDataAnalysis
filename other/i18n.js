...
const I18N = {
  ...
  "about.method.p1": { jp: "演武データは、WKFが採点シートと大会結果に使用する公式オンラインプラットフォームであるsportdata.orgから、手作業で収集・整理しました。データ処理と分析の主要言語としてPythonを使用し、以下のライブラリを用いました：" },
  "about.method.li1": { jp: "<strong>Pandas</strong>：データセットの構造化・クリーニング・操作に" },
  "about.method.li2": { jp: "<strong>NumPy</strong>：数値計算と記述統計に" },
  "about.method.p2": { jp: "本サイトのインタラクティブグラフは、JavaScriptライブラリの<strong>Chart.js</strong>で作成しています。" },
